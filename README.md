...
[MPF](https://github.com/SabreTools/MPF) releases are currently built as self-contained .NET Core 10 and do not [officially support](https://github.com/dotnet/core/blob/main/release-notes/10.0/supported-os.md) Windows versions older than Windows 10, however they have been tested working on Windows 7 SP1 (64bit). To get the MPF builds working on Windows 7 SP1 (64bit), you'll need to disable strong name validation due to `Microsoft.Management.Infrastructure` being unsigned. To do this, add the following registry keys:
```
